...
import com.inc.ocapop.objects.UserStreamView;
...
import static com.inc.ocapop.FragmentMain.ADMINISTRADOR;
import static com.inc.ocapop.FragmentMain.pathFotoUser;
...
//        }
    ...
    public void addCart(ProdObj obj) {
        ProdObjParcelable objParcelable = new ProdObjParcelable(obj.getCategorias(), obj.getDescr(),obj.isDisponivel(), obj.getIdProduto(), obj.getImgCapa(), obj.getImagens(),obj.getFabricante(), obj.getNivel(), obj.getProdName(), obj.getProdValor(), obj.getValorAntigo(), obj.isPromocional(), obj.getTag(), obj.getFornecedores());
